            ...
            <?php include "header.php"?>
                ...
                <div class="inner_content">
                    ...
                    <div class="inner_content_w3_agile_info two_in">
                        <h2 class="w3_inner_tittle">Send Query</h2>
                                            ...
                                            <div class="forms-grids">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label>
                                                            <input type="radio" name="reason" value="sendid"> SendID</label>
                                                    </div>
                                                    <div class="radio-inline">
                                                        <label>
                                                            <input type="radio" name="reason" value="query"> Query</label>
                                                    </div>
                                                   
                                                </div>
                                            </div>
                                              <label for="field-4-2">Type Your Message<span class="at-required-highlight">*</span></label>
                                                                <div class="form-group">
