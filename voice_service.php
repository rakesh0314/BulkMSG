            ...
            <?php include "header.php"?>
                ...
                <div class="inner_content">
                    ...
                    <div class="inner_content_w3_agile_info two_in">
                        <h2 class="w3_inner_tittle">Voice Service</h2>
                        <!---728x90--->
                                            ...
                                            <div class="form-body">
                                                <form class="form-horizontal" action="admin/inc/insertData.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="selector1" class="col-sm-2 control-label">Select Sender ID</label>
                                                        <div class="col-sm-8">
                                                   ...
                                                   <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" name="txtTitel" class="form-control1" id="focusedinput" placeholder="Enter Number">
                                                        </div>
                                                   ...
                                                   <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" name="txtContect" class="form-control1" id="focusedinput" placeholder="Enter Number">
                                                        </div>
                                                      
                                                    </div>
                                                      <div class="form-group">
                                        <label for="exampleInputFile" class="col-sm-2 control-label">Upload Contact</label>
                                          <div class="col-sm-8">
                                        <input type="file" id="exampleInputFile">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <div class="radio-inline">
                                                                <label>
                                                                    <input type="radio" checked="" name="Language">Hindi</label>
                                                            </div>
                                                  ...
                                                  <div class="form-group">
                                        <label for="exampleInputFile" class=" control-label">Upload Image</label>
